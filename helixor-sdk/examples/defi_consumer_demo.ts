// =============================================================================
// helixor-sdk/examples/defi_consumer_demo.ts — Day-42 DeFi reference consumer.
//
// What this file demonstrates
// ---------------------------
// A tiny DeFi protocol — "demo lending desk" — uses the Helixor SDK to gate
...
//
// Run: `tsx examples/defi_consumer_demo.ts` from the helixor-sdk root.
//
...
// real HelixorChainClient (or any RPC-backed ChainReader) and ships the
...
function epochIssuedAt(epoch: number): number {
  ...
  // EPOCH_SECONDS each. Matches the helixor-web mock's epoch math so the
...
// HelixorChainClient (or any RPC-backed ChainReader implementation).
// ─────────────────────────────────────────────────────────────────────────────
...
async function main(): Promise<void> {
  ...
  console.log("\nHELIXOR DeFi REFERENCE CONSUMER — payout decisions");
