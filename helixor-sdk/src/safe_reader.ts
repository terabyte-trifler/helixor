// =============================================================================
// helixor-sdk/src/safe_reader.ts — VULN-23 consumer-side guard rails.
//
// THE VULN-23 ATTACK
// ------------------
// A DeFi protocol that gates a loan on a Helixor trust score, but reads the
...
// (helixor-oracle/scoring/_gaming.py — `apply_delta_guard_rail`), but a
 ...
 *
 * Mirrors `MAX_SCORE_DELTA` in `helixor-oracle/scoring/_gaming.py`
...
// =============================================================================
// ChainReader — the minimal HelixorChainClient surface SafeCertReader needs
// =============================================================================

/**
 * The duck-typed surface the SafeCertReader requires. `HelixorChainClient`
