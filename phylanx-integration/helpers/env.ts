...
export function loadEnv(): IntegrationEnv {
  ...
  catch { throw new EnvError(`PHYLANX_PROGRAM_ID is not a valid base58 pubkey: ${programId}`); }
  ...
  return {
    ...
    skipOnchainTests:  process.env.PHYLANX_SKIP_ONCHAIN  === "1",
    skipFailureTests:  process.env.PHYLANX_SKIP_FAILURE  === "1",
  };
}
