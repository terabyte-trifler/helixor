#!/usr/bin/env tsx
// =============================================================================
// scripts/harden_rust.ts — programmatic Rust hardening for phylanx-programs.
//
...
// =============================================================================
// Where the phylanx-programs repo lives
// =============================================================================

const PROGRAMS_DIR = process.env.PHYLANX_PROGRAMS_DIR ?? "../phylanx-programs";
...
async function ensurePrograms() {
  try {
    ...
    throw new Error(
      `phylanx-programs not found at ${PROGRAMS_DIR}. ` +
      `Set PHYLANX_PROGRAMS_DIR or run from a sibling repo.`,
    );
  }
}
...
async function main() {
  ...
  console.log("");
  console.log("╔════════════════════════════════════════════════════════════╗");
  console.log("║  Phylanx — Day 13 Rust Hardening                          ║");
