    ...
    <footer className="border-t border-ink-3 mt-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-2.5 text-ink-12">
              <PhylanxMark size={30} />
              <span className="font-sans text-[16px] font-semibold uppercase tracking-[0.18em]">
                PHYLANX
              </span>
              <span className="font-mono text-[13px] text-ink-7">///</span>
            </div>
        ...
        <div className="mt-16 pt-8 border-t border-ink-3 flex flex-wrap items-center justify-between gap-4">
          <p className="text-[12px] text-ink-7">
            © 2026 Phylanx. Trust scoring is informational, not investment advice.
          </p>
...
function FooterCol({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div>
      <h3 className="eyebrow-accent">{title}</h3>
