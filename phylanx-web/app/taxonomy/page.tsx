  ...
  return (
    <div className="mx-auto max-w-5xl px-6 lg:px-10 py-16 lg:py-24">
      ...
      <p className="mt-6 max-w-[640px] text-[16px] text-ink-9 leading-relaxed">
        Every failure mode Phylanx can attest to lives in this table.
        ...
        tests in <code className="font-mono text-[13px] text-ink-11">phylanx-oracle/tests/diagnosis</code>{" "}
