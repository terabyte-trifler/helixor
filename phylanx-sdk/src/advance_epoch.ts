// =============================================================================
// phylanx-sdk/src/advance_epoch.ts — AW-02 client helpers for the
...
// not by Phylanx, so we do not redefine it.
// =============================================================================
 ...
 *
 * Distinct from the cert-signing tag (`phylanx-cert-v1`) and the challenge
 * tag (`phylanx-aw01-ext-challenge`) — this prevents an honest cluster
