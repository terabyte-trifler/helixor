// =============================================================================
// phylanx-sdk/src/client.ts — the Phylanx SDK client.
//
// `PhylanxClient.getScore(agent)` is the MVP-compatible entry point. In the
...
export class PhylanxChainClient {
  constructor(
    private readonly connection: Connection,
    private readonly programs: PhylanxProgramIds
  ) {}
