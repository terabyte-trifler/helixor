"""
conftest.py — pytest path setup for the Phylanx indexer test suite.
...
_ORACLE_ROOT = _INDEXER_ROOT.parent / "phylanx-oracle"
_API_ROOT = _INDEXER_ROOT.parent / "phylanx-api"
