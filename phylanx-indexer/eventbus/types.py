"""
eventbus/types.py — typed contracts for the Phylanx Kafka event pipeline.
...
"effectively once". Phylanx's design is the pragmatic, correct one:
...
class Topic(str, enum.Enum):
    """The Kafka topics the Phylanx pipeline uses."""
    ...
    # substrate is `phylanx-oracle/oracle/cert_refusal_log.py` —
...
class EventRecord:
    ...
    to the same partition, which preserves per-key ordering. Phylanx keys
