...
logger = logging.getLogger("phylanx.eventbus.confluent")
...
class ConfluentKafkaConfig:
    ...
    def __init__(
        ...
        *,
        client_id: str = "phylanx-eventbus",
    ...
    def from_env(
        ...
        *,
        ...
        unless `PHYLANX_KAFKA_PLAINTEXT_OK=1` is set.
        ...
        Reads (defaults):
            ...
            PHYLANX_NETWORK          (default: localnet)
            PHYLANX_KAFKA_PLAINTEXT_OK    (escape hatch)
        """
    ...
    def consumer_config(self, group: str) -> dict[str, Any]:
        ...
        `enable.auto.commit=False` is essential: Phylanx commits MANUALLY,
        ...
        return {
            ...
            "group.id":           group,
            "client.id":          self.client_id,
            "enable.auto.commit": False,       # Phylanx commits manually
