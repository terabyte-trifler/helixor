...
Two pieces, this file is the first one:
  ...
  (2) `phylanx-oracle/oracle/lag_gate.py` — wraps the oracle's per-agent
...
logger = logging.getLogger("phylanx.eventbus.lag_monitor")
...
_ENV_MAX_PARTITION_LAG = "PHYLANX_CONSUMER_LAG_MAX_PARTITION"
...
_ENV_MAX_TOTAL_LAG = "PHYLANX_CONSUMER_LAG_MAX_TOTAL"
