...
helixor-api in-memory impl does (`api/evidence_repo.InMemoryEvidencePayloadRepo`)
...
# The Day-39 record dataclass + Protocol live in helixor-api. We import
...
class TimescaleEvidencePayloadRepo:
    ...
    duck-typed) so the helixor-api route handler reads through it
