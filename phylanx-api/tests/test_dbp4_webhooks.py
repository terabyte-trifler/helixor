...
These tests pin:
  ...
  * `compute_signature` is HMAC-SHA256 of the canonical body. A
    ...
    the exact value we send in the `X-Phylanx-Webhook-Signature`
    header.
...
WEBHOOK_URL      = "https://partner.example.com/phylanx/cert-degrading"
...
class TestLoadWebhooksFromEnv:
    ...
    def test_url_with_port_preserved(self, monkeypatch) -> None:
        ...
        url_with_port = "https://partner.example.com:8443/phylanx/hook"
        monkeypatch.setenv(
            "PHYLANX_WEBHOOKS",
