...
// Phylanx API would force every trust_gate to either:
//
...
//      `PhylanxClient.requireMinScore`'s policy. Same precedence
 ...
 *
 * Mirrors `PhylanxClient.requireMinScore` (phylanx-sdk/src/http_client.ts).
