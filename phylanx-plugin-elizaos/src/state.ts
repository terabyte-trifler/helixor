// =============================================================================
// @elizaos/plugin-phylanx — plugin state (Day 12 + VULN-12 extensions).
// Owns the TelemetryBeaconClient lifecycle and the VULN-12 last-known-good
// ScoreCache.
// =============================================================================

import { PhylanxClient, type TrustScore } from "@phylanx/client/unsafe";

import type { PhylanxPluginConfig } from "./config";
...
export class PluginState {
  public readonly client:     PhylanxClient;
  public readonly beacon:     TelemetryBeaconClient;
  public readonly config:     PhylanxPluginConfig;
  ...
  // PHYLANX_AUTO_PAUSE_STATUS action. Written by `evaluatePauseFromScore`.
  public paused = false;
  ...
  constructor(config: PhylanxPluginConfig) {
    this.config = config;
    this.client = new PhylanxClient({
...
export function getOrInitState(runtime: object, config: PhylanxPluginConfig): PluginState {
