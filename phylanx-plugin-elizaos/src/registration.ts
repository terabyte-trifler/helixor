// =============================================================================
// @elizaos/plugin-phylanx — on-chain registration helper.
//
...
const PHYLANX_PROGRAM_ID = new PublicKey("Cnn6AWzKD6NjwNZNsJnDYYYTTjt2C9Gow2TZoXzK3U5P");
