...
fn vuln13_error_codes_are_stable() {
    assert_eq!(PhylanxError::NotRotationProposer       as u32, 6060);
    assert_eq!(PhylanxError::NotClusterMemberAttester  as u32, 6061);
    assert_eq!(PhylanxError::TimelockTooShort          as u32, 6062);
    assert_eq!(PhylanxError::PendingRotationExists     as u32, 6063);
    assert_eq!(PhylanxError::NoopRotation              as u32, 6064);
    assert_eq!(PhylanxError::TimelockNotElapsed        as u32, 6065);
    assert_eq!(PhylanxError::InsufficientAttestations  as u32, 6066);
    assert_eq!(PhylanxError::DuplicateAttestation      as u32, 6067);
    assert_eq!(PhylanxError::OracleConfigMismatch      as u32, 6068);
}
