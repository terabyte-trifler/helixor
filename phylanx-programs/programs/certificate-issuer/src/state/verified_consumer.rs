...
//
//     sha256( "phylanx-dbp2-verified-consumer" || partner_wallet || integration_hash )
//
...
impl VerifiedConsumer {
    ...
    /// from cert-signing (`phylanx-cert-...`) and challenge-attestation
    /// (`phylanx-aw01-ext-challenge`) so a registration signature cannot be
    /// lifted to any other surface or vice versa.
    pub const DOMAIN_TAG: &'static [u8] = b"phylanx-dbp2-verified-consumer";
...
///
/// Layout (fixed, public):
///   "phylanx-dbp2-verified-consumer"  (30 bytes)
...
mod tests {
    ...
    fn domain_tag_is_pinned() {
        ...
        assert_eq!(
            VerifiedConsumer::DOMAIN_TAG,
            b"phylanx-dbp2-verified-consumer",
        );
