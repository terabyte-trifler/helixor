...
// the score (see phylanx-oracle/oracle/cluster/input_commitment.py). Folding
...
// labels (see `phylanx-oracle/scoring/bundle_hash.py`). The trailing
...
/// The off-chain signer (phylanx-oracle/oracle/cluster/cert_signing.py)
...
/// `phylanx-oracle/scoring/bundle_hash.py`). `score_components_hash`
