...
//
//     sha256( "phylanx-aw01-ext-challenge" || cert_pubkey || true_block_hash )
//
...
const CHALLENGE_DOMAIN_TAG: &[u8] = b"phylanx-aw01-ext-challenge";
...
///
/// Layout (fixed, public):
///   "phylanx-aw01-ext-challenge"  (26 bytes)
