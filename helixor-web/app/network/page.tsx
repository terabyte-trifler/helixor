...
export const metadata: Metadata = {
  title: "Network",
  description: "Live status of the Helixor BFT oracle cluster.",
};
    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-10 py-16 lg:py-24">
      ...
      <div>
        ...
        <p className="mt-6 max-w-[560px] text-[16px] text-ink-9 leading-relaxed">
          Helixor publishes everything: every node, every epoch, every
      ...
      <section className="mt-20">
        <div className="flex items-end justify-between mb-6">
          <span className="eyebrow">Last 10 epochs</span>
          <span className="text-[12px] font-mono text-ink-7">
      ...
      <section className="mt-20">
        <div className="flex items-end justify-between mb-6">
          <div>
            <span className="eyebrow">Watchdog activity</span>
            <h2 className="mt-2 text-[24px] text-ink-12 tracking-tight">
            ...
            {byz.flags.map((f, i) => (
              ...
              >
                <div className="flex items-start justify-between gap-4 flex-wrap">
                  ...
                  <a
                    href="#"
                    className="inline-flex items-center gap-1 text-[12px] text-chain hover:underline"
                  >
