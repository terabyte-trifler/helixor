...
export const metadata: Metadata = {
  title: "Docs",
  description: "Integrate Helixor in two lines — SDK or REST.",
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 lg:px-10 py-16 lg:py-24">
      ...
      <p className="mt-6 text-[17px] text-ink-9 leading-relaxed max-w-[560px]">
        Helixor exposes two read paths: an{" "}
      ...
      <Section id="install" eyebrow="01" title="Install">
        <CodeBlock lang="bash" code={`npm install @helixor/sdk @solana/web3.js`} />
      </Section>
...
import { HelixorClient } from "@helixor/sdk";

const connection = new Connection("https://api.mainnet-beta.solana.com");
const helixor = new HelixorClient({ connection });
...

{
  ...
  "computed_at":     "2026-05-22T11:00:00.000Z"
        ...
        <p>
          ...
          <a href="https://api.helixor.xyz/docs" className="text-chain hover:underline">
            /docs
          </a>.
        </p>
      </Section>
      ...
      <Section id="architecture" eyebrow="04" title="What you're actually reading">
        ...
        <p>
          ...
          <a href="https://github.com/helixor/helixor" className="text-chain hover:underline inline-flex items-center gap-1">
            github.com/helixor <ArrowUpRight size={12} />
          </a>
        </p>
      </Section>
  ...
  return (
    <section id={id} className="mt-20 scroll-mt-24">
      <div className="flex items-baseline gap-4">
        <span className="font-mono text-[11px] text-ink-7 tracking-eyebrow uppercase tabular-nums">
          {eyebrow}
        </span>
