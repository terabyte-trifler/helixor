...
/* ── Shared: the bordered mono pill ─────────────────────────────────────── */

function Pill({
  icon, children, dark = false,
    ...
    <section className="border-t border-ink-3">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-24 lg:py-28">
        <SectionHead
          ...
          sub="Helixor is a closed loop — detection, consensus, signatures, and storage — engineered together for one job: a score nobody has to take on faith."
        />
        <div className="mt-16">
          <ApproachSteps />
        </div>
          ...
          <div className="bg-ink-1 p-8 lg:p-10 space-y-8">
            <CompareRow
              ...
              rows={[
                ...
                { name: "helixor", value: "3 of 5 — each staked, each slashable", bar: <GoodBar filled={3} total={10} />, good: true },
              ]}
            />
            <CompareRow
              ...
              rows={[
                ...
                { name: "helixor", value: "recompute the digest, check 3 signatures", good: true },
              ]}
            />
          </div>
          <div className="bg-ink-1 p-8 lg:p-10 space-y-8">
            <CompareRow
              ...
              rows={[
                ...
                { name: "helixor", value: "flagged on-chain · struck · stake slashed", good: true },
              ]}
            />
            <CompareRow
              ...
              rows={[
                ...
                { name: "helixor", value: "$0 — permissionless, on-chain or cached", good: true },
              ]}
            />
          </div>
        </Reveal>
