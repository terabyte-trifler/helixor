...
const BOOT: Line[] = [
  { text: "$ helixor node start --network devnet",                 tone: "cmd"   },
...
export function Terminal({ className }: { className?: string }) {
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Terminal: a Helixor oracle node runs one scoring epoch, flags a deviating node, and anchors a threshold-signed certificate on-chain"
    >
      {/* Title bar */}
