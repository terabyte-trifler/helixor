"""
audit/test_vuln22_version_pinning_check.py — pin tests for the VULN-22
version-pinning sweep.
...
from version_pinning_check import (  # type: ignore  # noqa: E402
    main, scan,
)
...
class TestRealCodebaseClean:
    ...
    def test_repo_has_no_version_pinning_findings(self):
        report = scan()
        assert report.findings == [], (
            "the repo grew a VULN-22 version-pinning finding:\n"
            + "\n".join(
