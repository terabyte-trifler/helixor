"""
audit/test_vuln24_adversarial_ml_check.py — pin tests for VULN-24.
...
from adversarial_ml_check import (  # type: ignore  # noqa: E402
    main, scan,
)
...
class TestRealCodebaseClean:
    ...
    def test_repo_has_no_adversarial_ml_findings(self):
        report = scan()
        assert report.findings == [], (
            "the repo grew a VULN-24 adversarial-ML finding:\n"
            + "\n".join(
