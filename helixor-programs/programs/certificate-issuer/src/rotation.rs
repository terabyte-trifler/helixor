...
//
//   - a fixed DOMAIN TAG ("helixor-m06-cluster-rotation"), so the digest
...
/// (`b"helixor-aw01-ext-challenge"`) so an attacker cannot lift a cert
/// signature or a challenge signature and reuse it as a rotation
/// signature, or vice versa.
pub const ROTATION_DOMAIN_TAG: &[u8] = b"helixor-m06-cluster-rotation";
...
mod tests {
    ...
    fn digest_uses_distinct_domain_tag() {
        ...
        assert_eq!(ROTATION_DOMAIN_TAG, b"helixor-m06-cluster-rotation");
        assert_ne!(ROTATION_DOMAIN_TAG, b"helixor-aw01-ext-challenge");
    }
