...
pub fn handler(
    ...
    require!(is_admin || is_member, HelixorError::NotRotationProposer);
    ...
    require!(new_keys.len() != 2, HelixorError::InvalidClusterSize);
    ...
    require!(!(same_keys && same_conf), HelixorError::NoopRotation);
